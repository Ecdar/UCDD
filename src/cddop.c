...
ddNode* cdd_exist(ddNode* node, int32_t* levels_bool, int32_t* clocks, int32_t num_bool_resets, int32_t num_clock_resets)
{
    int32_t i, j;
...
static ddNode* cdd_exist_rec(ddNode* node, int32_t* levels_bool, int32_t* clocks,
